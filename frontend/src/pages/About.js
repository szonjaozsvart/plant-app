...
function About() {
  return (
    <Grid padding={2}>
      <Grid display="flex" alignItems="center" justifyContent="center">
        ...
        <ImageList sx={{ maxWidth: 200, maxHeight: 200 }} cols={3}>
          <a href="https://www.facebook.com/" target="_blank" rel="noreferrer">
            <FacebookIcon sx={{ height: 50, width: 50 }} />
          </a>
      ...
      <Typography color="#0095a0" fontWeight="bold" fontSize={30}>
        Our Mission
      </Typography>
      <Typography
        padding={3}
      ...
      >
        ...
        and scrambled it to make a type s pecimen book. It has survived not only
        five centuries, but also the leap into electronic typesetting, remaining
        essentially unchanged. It was popularised in the 1960s with the release
        of Letraset sheets containing Lorem Ipsum passages, and more recently
        with desktop publishing software like Aldus PageMaker including versions
      ...
      <Grid display="flex" flexDirection="row" margin={2}>
        <ReactPlayer url="https://www.youtube.com/watch?v=JkK8g6FMEXE&list=RDNeSpx7vZifc&index=2"></ReactPlayer>
        <ReactPlayer url="https://www.youtube.com/watch?v=MYUmZMfVLE4"></ReactPlayer>
        <ReactPlayer url="https://www.youtube.com/watch?v=hlSIGK7S8Is"></ReactPlayer>
      </Grid>
      <Typography
        display="flex"
        alignItems="center"
